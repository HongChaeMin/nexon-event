...
var BaseEntity = function () {
    ...
    return _a = /** @class */ (function () {
            function BaseEntity() {
                ...
                this.createdAt = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _createdAt_initializers, new Date()));
                this.updatedAt = (__runInitializers(this, _createdAt_extraInitializers), __runInitializers(this, _updatedAt_initializers, new Date()));
        ...
        (function () {
            ...
            _id_decorators = [(0, typeorm_1.ObjectIdColumn)()];
            _createdAt_decorators = [(0, typeorm_1.Column)({ type: 'timestamp' })];
            _updatedAt_decorators = [(0, typeorm_1.Column)({ type: 'timestamp' })];
