...
var base_entity_1 = require("../../../database/entities/base.entity");
var role_type_1 = require("../types/role.type");
var Member = function () {
    ...
    var Member = _classThis = /** @class */ (function (_super) {
        __extends(Member_1, _super);
        function Member_1() {
    ...
    (function () {
        ...
        _name_decorators = [(0, typeorm_1.Column)({ nullable: false })];
        _email_decorators = [(0, typeorm_1.Column)({ unique: true, nullable: false })];
        _password_decorators = [(0, typeorm_1.Column)({ nullable: false })];
        _role_decorators = [(0, typeorm_1.Column)({ type: 'enum', enum: role_type_1.RoleType })];
